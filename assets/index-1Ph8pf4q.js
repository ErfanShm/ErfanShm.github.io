...
`;function Ke({duration:t=1e3,delay:r=0,timingFunction:e="ease",keyframes:n=Ut,iterationCount:a=1}){return $r`
  ...
  `}function Ze(t){return t==null}function Qe(t){return typeof t=="string"||typeof t=="number"||typeof t=="boolean"}function kr(t,r){return e=>e?t():r()}function J(t){return kr(t,()=>null)}function Pt(t){return J(()=>({opacity:0}))(t)}const Rr=t=>{const{cascade:r=!1,damping:e=.5,delay:n=0,duration:a=1e3,fraction:o=0,keyframes:i=Ut,triggerOnce:c=!1,className:f,style:d,childClassName:l,childStyle:u,children:$,onVisibilityChange:I}=t,v=w.useMemo(()=>Ke({keyframes:i,duration:a}),[a,i]);return Ze($)?null:Qe($)?k(rn,{...t,animationStyles:v,children:String($)}):Xe.isFragment($)?k(Ar,{...t,animationStyles:v}):k(Ee,{children:w.Children.map($,(m,E)=>{if(!w.isValidElement(m))return null;const x=n+(r?E*a*e:0);switch(m.type){case"ol":case"ul":return k(Rt,{children:({cx:p})=>k(m.type,{...m.props,className:p(f,m.props.className),style:Object.assign({},d,m.props.style),children:k(Rr,{...t,children:m.props.children})})});case"li":return k(er,{threshold:o,triggerOnce:c,onChange:I,children:({inView:p,ref:C})=>k(Rt,{children:({cx:_})=>k(m.type,{...m.props,ref:C,className:_(l,m.props.className),css:J(()=>v)(p),style:Object.assign({},u,m.props.style,Pt(!p),{animationDelay:x+"ms"})})})});default:return k(er,{threshold:o,triggerOnce:c,onChange:I,children:({inView:p,ref:C})=>k("div",{ref:C,className:f,css:J(()=>v)(p),style:Object.assign({},d,Pt(!p),{animationDelay:x+"ms"}),children:k(Rt,{children:({cx:_})=>k(m.type,{...m.props,className:_(l,m.props.className),style:Object.assign({},u,m.props.style)})})})})}})})},tn={display:"inline-block",whiteSpace:"pre"},rn=t=>{const{animationStyles:r,cascade:e=!1,damping:n=.5,delay:a=0,duration:o=1e3,fraction:i=0,triggerOnce:c=!1,className:f,style:d,children:l,onVisibilityChange:u}=t,{ref:$,inView:I}=Er({triggerOnce:c,threshold:i,onChange:u});return kr(()=>k("div",{ref:$,className:f,style:Object.assign({},d,tn),children:l.split("").map((v,m)=>k("span",{css:J(()=>r)(I),style:{animationDelay:a+m*o*n+"ms"},children:v},m))}),()=>k(Ar,{...t,children:l}))(e)},Ar=t=>{const{animationStyles:r,fraction:e=0,triggerOnce:n=!1,className:a,style:o,children:i,onVisibilityChange:c}=t,{ref:f,inView:d}=Er({triggerOnce:n,threshold:e,onChange:c});return k("div",{ref:f,className:a,css:J(()=>r)(d),style:Object.assign({},o,Pt(!d)),children:i})};s`
  from,
  20%,
  40%,
  60%,
